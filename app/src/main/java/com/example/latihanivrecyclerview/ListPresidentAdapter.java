package com.example.latihanivrecyclerview;
...
public class ListPresidentAdapter extends RecyclerView.Adapter<ListPresidentAdapter.CategoryViewHolder> {
    ...
    @NonNull
    @Override
    public ListPresidentAdapter.CategoryViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ListPresidentAdapter.CategoryViewHolder categoryViewHolder, int position) {
